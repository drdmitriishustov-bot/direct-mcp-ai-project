...
Любой workflow этого скилла заверши итогом в чат: что проверено или изменено, период и ключевые цифры если есть, вывод, применённые или предлагаемые действия, обновлённый файл. Файлы кампаний и технические логи не заменяют ответ пользователю.
...
5. **Обновить файл кампании** `campaigns/<utm>.md` — добавить строку в таблицу результатов и обновить «Где сейчас».
