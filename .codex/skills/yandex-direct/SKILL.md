...
Любой workflow этого скилла заверши итогом в чат: что проверено или изменено, период и ключевые цифры если есть, вывод, применённые или предлагаемые действия, обновлённую запись в Workspace если она менялась. Workspace и технические логи не заменяют ответ пользователю.
