...
Любой workflow этого скилла заверши итогом в чат: что создано, проверено или изменено, период и ключевые цифры если есть, вывод, применённые или предлагаемые действия, обновлённый файл. Файлы кампаний и технические логи не заменяют ответ пользователю.
