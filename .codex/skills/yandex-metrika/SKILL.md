...
Любой workflow этого скилла заверши итогом в чат: что проверено, период, ключевые метрики, вывод, рекомендации и обновлённый файл если он менялся. Файл кампании и отчётные таблицы не заменяют ответ пользователю.
