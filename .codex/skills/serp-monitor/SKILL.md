...
Любой workflow этого скилла заверши итогом в чат: какие запросы проверены, какие позиции изменились, что это значит для CTR/CPA, что делать дальше и обновлённый файл если он менялся. CSV-история и файл кампании не заменяют ответ пользователю.
