...
Любой workflow этого скилла заверши итогом в чат: что исследовано, какие выводы по спросу или интенту, что добавить, что минусовать, где риск каннибализации или сезонности, следующий шаг и обновлённый файл если он менялся. CSV, таблицы и файлы кампаний не заменяют ответ пользователю.
...
- **Результаты всех исследований** — сохранять в `campaigns/<utm>.md` с датой и выводами, а ключевые выводы и рекомендации обязательно дублировать в чат.
